...
builder.Services.Configure<CookiePolicyOptions>(options =>
{
    ...
    options.ConsentCookie.IsEssential = true; // Optional, but can help avoid blocking by some browsers
    options.ConsentCookie.Domain = "findservice.ca"; // Set to the root domain
    */
});
