    ...
    public class CreateModel : BasePageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (user.Email != null)
            {
                ...
                {
                    _emailService.SendSupportTicketCreated(user.Email, $"/SupportTickets/Details?Id={supportTicketId}");

                }
                _emailService.SendSupportTicketCreated("support@findservice.ca", $"/SupportTickets/Details?Id={supportTicketId}");
            }
