    ...
    public class DetailsModel : BasePageModel
    {
        ...
        public async Task<IActionResult> OnPostSendMessageAsync()
        {
            ...
            if (user.Id == supportTicket.UserId)
            {
                ...
                _emailService.SendMessageNotification("support@findservice.ca", $"/SupportTickets/Details?Id={Input.ResourceId}");
            }
            else
            {
                //It has to be the admins
                if (supportTicket.EmailAddress != null) _emailService.SendMessageNotification(supportTicket.EmailAddress, $"/SupportTickets/Details?Id={Input.ResourceId}");
            }
